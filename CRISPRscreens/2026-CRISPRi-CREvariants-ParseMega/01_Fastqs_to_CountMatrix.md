...
cd data/Seqmatic_032026_Parse_Mega_CREvariants
```
...
Save the following script as BM083_WT_splitpipe_array.sh
```bash
#!/bin/bash
#SBATCH --job-name=BM083_WT_splitpipe
#SBATCH --output=/home/users/jo912684/data/Seqmatic_032026_Parse_Mega_CREvariants/slurm_logs/BM083_WT_splitpipe_%A_%a.out
#SBATCH --error=/home/users/jo912684/data/Seqmatic_032026_Parse_Mega_CREvariants/slurm_logs/BM083_WT_splitpipe_%A_%a.err
...
# -----------------------------
WORKDIR="/home/users/jo912684/data/Seqmatic_032026_Parse_Mega_CREvariants"
GENOME_DIR="/home/users/jo912684/data/genomes/GRCh38/"
KIT="WT_mega"
CHEM="v3"
SLT="${WORKDIR}/02a-BM083-Parse_WT_Mega_SLT_v2.1-260226_Copy.xlsm"

# This script is for WT only
PREFIX="BM083-WT-Sublibrary"
...
```bash
cp "02a-BM083-Parse Biosciences Evercode WT Mega INTEGRA Sample Loading Table v2.1 - 260317 - Copy.xlsm" 02a-BM083-Parse_WT_Mega_SLT_v2.1-260226_Copy.xlsm
mkdir -p /home/users/jo912684/data/Seqmatic_032026_Parse_Mega_CREvariants/slurm_logs
sbatch BM083_WT_splitpipe_array.sh
```
...
This identified just 1 subset:
- 7695 sgRNAs

All sgRNAs were kept moving forward.
